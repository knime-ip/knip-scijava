...
import org.knime.scijava.commands.adapter.basic.BooleanOutputAdapter;
import org.knime.scijava.commands.adapter.basic.ByteOutputAdapter;
import org.knime.scijava.commands.adapter.basic.CharOutputAdapter;
import org.knime.scijava.commands.adapter.basic.IntOutputAdapter;
import org.knime.scijava.commands.adapter.basic.LongOutputAdapter;
import org.knime.scijava.commands.adapter.basic.ShortOutputAdapter;
import org.knime.scijava.commands.adapter.basic.StringOutputAdapter;
...
public class OutputAdapterConverterTest {
	...
	public <T> void testOutputAdapterConversion(T o, Class<? extends OutputAdapter<?, ?>> oa,
		...
		assertNotNull("Plugin " + oa.getClass().getName() + " could not be found", convertService.getInstance(oa));
