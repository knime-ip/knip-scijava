 ...
 *            
 * TODO: This sadly doesn't do the job. Sometimes it is not possible to set
 * set value just from Object.
 */
public interface SettingsModelType<T extends SettingsModel, V> {

	
	/**
	 * Create a new SettingsModel instance with type described
	 * by this SettingsModelType.
	 * @param name Name of the SettingsModel.
	 * @param defaultValue DefaultValue for this SettingsModel
	 * @return
	 */
